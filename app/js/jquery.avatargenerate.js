...
(function ( $ ) {
    ...
    function AvatarGenerate()
    {
        ...
        this.loadToClothes = function( type )
        {
            ...
            jQuery.each( load.sets, function( index, value )
            {
                if( value.gender == _this.gender && value.selectable == 1 || value.gender == "U" && value.selectable == 1 )
                {
                    ...
                    asset.css( 'background-image', 'url( https://www.habbo.com.tr/habbo-imaging/avatarimage?figure=' + partString + '&gender=' + _this.gender + ' )' );
        ...
        {
            var URL = "http://www.habbo.com.tr/habbo-imaging/avatarimage?head_direction=4&direction=4&size=l&figure=" + this.buildFigure() + "&gender=" + this.getGender();
